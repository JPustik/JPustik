...
Проходил курсы GeekBrains frontend-разработчик. Я делал разные проекты, например: Интернет-магазин(для портфолио), сайт спецтехники в аренду(для компании «РусПромТех»). Оба эти прокета закрепил ниже)
<h1></h1>
<h3>💪🏼Мои скиллы</h3>
<div>
